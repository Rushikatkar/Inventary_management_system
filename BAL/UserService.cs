    ...
    public class UserService : IUserService
    {
        ...
        public async Task<User> RegisterUserAsync(RegisterUserDTO registerUserDTO)
        {
            try
            {
                ...
                user.Password = GenerateHashedPassword(registerUserDTO.Password);
        ...
        public async Task<User> UpdateUserAsync(UpdateUserDTO updateUserDTO)
        {
            try
            {
                ...
                if (!string.IsNullOrEmpty(updateUserDTO.Password))
                {
                    ...
                    newuser.Password = GenerateHashedPassword(updateUserDTO.Password);
                }
        ...
        public async Task<string> LoginUserAsync(LoginUserDTO loginUserDTO)
        {
            try
            {
                ...
                // Verify the password
                if (!VerifyPassword(user.Password, loginUserDTO.Password))
                {
                    throw new Exception("Invalid credentials.");
                }
