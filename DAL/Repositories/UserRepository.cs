    ...
    public class UserRepository : IUserRepository
    {
        ...
        public async Task<User> RegisterUserAsync(RegisterUserDTO registerUserDTO)
        {
            ...
            var user = new User
            {
                ...
                Password = registerUserDTO.Password,  // Password should be hashed before storing
        ...
        public async Task<User> UpdateUserAsync(UpdateUserDTO updateUserDTO)
        {
            ...
            if (!string.IsNullOrEmpty(updateUserDTO.Password))
                user.Password = updateUserDTO.Password;  // You should hash the password before updating
